<!DOCTYPE html><html lang="en"><head><title>Unsubscribe from email</title>
...
(function () {
    ...
    s.parentNode.insertBefore(wzrk, s);
      ...
      console.log("Harsh");
      console.log("Yo"+clevertap.getCleverTapID());
      clevertap.getCleverTapID();
      </script>
      </head>
      <body><div><h4>I want to unsubscribe from future emails</h4><input id="email" type="text" readonly="readonly"><br><br><button onclick="unsubscribe()">Unsubscribe me</button></div><script>// on  page load, fetch the email id of the user
