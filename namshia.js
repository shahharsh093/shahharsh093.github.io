function __wizrocket() {
  ...
  wiz.setUpWebPushNotifications = function (subscriptionCallback, serviceWorkerPath, apnsWebPushId, apnsServiceUrl) {
    if(navigator.userAgent.indexOf('Chrome') !== -1 || navigator.userAgent.indexOf('Firefox') !== -1){
      wiz.setUpChromeFirefoxNotifications(subscriptionCallback, serviceWorkerPath, true);
   ...
   */
  wiz.setUpChromeFirefoxNotifications = function (subscriptionCallback, serviceWorkerPath, tryAfterUnsub) {

    wc.l("setUpChromeFirefoxNotifications called with tryAfterSub=" + tryAfterUnsub);
          ...
          serviceWorkerRegistration['pushManager']['getSubscription']()['then'](function (subscription) {
            if (subscription !== null) {
              subscription['unsubscribe']()['then'](function (successful) {
                ...
                if(tryAfterUnsub && fcmPublicKey != null && !equalArrayBuffers(subscription.options.applicationServerKey, fcmPublicKey)) {
                  wiz.setUpChromeFirefoxNotifications(subscriptionCallback, serviceWorkerPath, false)
                }
